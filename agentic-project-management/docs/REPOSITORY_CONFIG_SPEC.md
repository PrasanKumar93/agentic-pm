...
- a registration form for name, URL, default branch, and local path
- managed repository cards showing id, URL, local path, default branch, and routed work item count
...
- Add branch policy controls per repository.
